...
console.log(`foodList.indexOf('물회') : ${foodList.indexOf('물회')}`);                  // 0 : 배열에서 인덱스 순서
console.log(`foodList.indexOf('물회', 1) : ${foodList.indexOf('물회', 1)}`);            // 4 : 배열에서 인덱스 1번째부터 값 검색하여 찾기
console.log(`foodList.indexOf('삼겹살') :  ${foodList.indexOf('삼겹살')}`);             // -1 : 존재하지 않는 값
...
console.log(`foodList.includes('물회') : ${foodList.includes('물회')}`);                // true : 포함하고 있다.
console.log(`foodList.includes('삼겹살') : ${foodList.includes('삼겹살')}`);            // false : 없다.
